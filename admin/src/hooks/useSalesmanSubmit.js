...
const useSalesmanSubmit = (id) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (id) {
                const res = await SalesmanServices.updateSalesman(id, roleData);
                setIsUpdate(true);
                notifySuccess(res.message);
                closeDrawer();
            } else {
                const res = await SalesmanServices.addSalesman(roleData);
                setIsUpdate(true);
                notifySuccess(res.message);
                closeDrawer();
            }
    ...
    const getRoleData = async () => {
        try {
            const res = await SalesmanServices.getSalesmanById(id, {
                name: adminInfo.name,
            });
            if (res) {
                setResData(res);
...
export default useSalesmanSubmit;
