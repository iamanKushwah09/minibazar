...
import SelectCategoryGroup from "../form/selectOption/SelectCategoryGroup";
    ...
    <>
      <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
        <Title
          ...
          title={id ? t("Update Category") : t("Add Category")}
        //   description={
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="px-6 pt-8 flex-grow scrollbar-hide w-full max-h-full pb-40">
                ...
                {isCombination ? <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  <LabelArea label="Parent category" status />
                  <div className="col-span-8 sm:col-span-4">
                    <SelectCategoryGroup register={register} label="Parent category" name="parent_id" />
