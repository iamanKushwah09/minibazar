...
const CategoryTable = ({ dataTable, lang }) => {
    const {
        title,
        serviceId,
        handleModalOpen,
            ...
            <TableBody>
                {dataTable?.map((e) => (
                    <TableRow key={e._id}>
                        <TableCell>
                            <img
                                src={e?.image ? `${import.meta.env.VITE_APP_API_SOCKET_URL}${e?.image}` : `${import.meta.env.VITE_APP_DEFAULT_IMAGE_URL}`}
                                alt="Category Image"
                        ...
                        <TableCell>
                            <h2 className="text-sm font-medium">
                                {showingTranslateValue(e?.name)}
                            </h2>
                        </TableCell>
                        <TableCell>
                            <span className="text-sm">{showingTranslateValue(e?.description)}</span>{" "}
                        </TableCell>
