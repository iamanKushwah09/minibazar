...
const Offer = () => {
  ...
  const { data, loading, error } = useAsync(() =>
    OfferServices.getAllOffer({ email: adminInfo.email })
  );
        ...
        <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 mb-5">
          <CardBody>
            ...
            >
              ...
              <div className="mt-2 md:mt-0 flex offers-center xl:gap-x-4 gap-x-1 flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          <Table>
            ...
            <OfferTable dataTable={dataTable} lang={lang} />
          </Table>
          <TableFooter>
            <Pagination
        ...
        <NotFound title="Sorry, There are no offer right now." />
      )}
    </>
  );
};
