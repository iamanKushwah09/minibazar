...
const Category = () => {
  ...
  const { data, loading, error } = useAsync(() =>
    CategoryServices.getAllCategory1({ email: adminInfo.email })
  );
  ...
  const syncCategory = async () => {
    setSyncLoading(true);
    try {
      const res = await CategoryServices.syncCategory();
        ...
        <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 mb-5">
          <CardBody>
            ...
            >
              ...
              <div className="mt-2 md:mt-0 flex categorys-center xl:gap-x-4 gap-x-1 flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                <Button
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          <Table>
            ...
            <CategoryTable dataTable={dataTable} lang={lang} />
          </Table>
          <TableFooter>
            <Pagination
