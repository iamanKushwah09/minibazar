...
import AttributeGroupDrawer from "@/components/drawer/AttributeGroupDrawer";
...
import AttributeGroupTable from "@/components/attributes/AttributeGroupTable";
...
const AttributeGroup = () => {
  ...
  const { data, loading, error } = useAsync(() =>
    AttributeGroupServices.getAllAttributeGroup({ email: adminInfo.email })
  );

  // syncAttributeGroup
  const syncAttributeGroup = async () => {
    setSyncLoading(true);
    try {
      const res = await AttributeGroupServices.syncAttributeGroup();
      ...
      const errorMessage =
        ...
        err.message ||
        "Failed to sync attribute groups";
  ...
  return (
    <>
      <PageTitle>{t("Attribute Group")} </PageTitle>
      <MainDrawer>
        <AttributeGroupDrawer />
      </MainDrawer>
      <AnimatedContent>
            ...
            >
              <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                <Input
                  ...
                  type="search"
                  name="search"
                  placeholder={t("Search Attribute Group")}
                />
                <button
                  type="submit"
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          <Table>
            ...
            <AttributeGroupTable dataTable={dataTable} lang={lang} />
          </Table>
          <TableFooter>
            <Pagination
