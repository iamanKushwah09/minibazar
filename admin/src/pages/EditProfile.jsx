...
const EditProfile = () => {
  ...
  const { register, handleSubmit, onSubmit, errors, newImage , setNewImage, watch, setValue } = useStaffSubmit(adminInfo._id);
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="p-6 flex-grow scrollbar-hide w-full max-h-full">
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div className="col-span-8 sm:col-span-4">
                  <SelectRole register={register} label="Role" name="role" value={watch("role")} setValue={setValue} />
