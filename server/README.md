...
If your Windows Server exposes a loopback DNS resolver to Node.js and you are connecting to MongoDB Atlas with `mongodb+srv://`, set `MONGO_DNS_SERVERS` to a comma-separated list such as `1.1.1.1,8.8.8.8`.
